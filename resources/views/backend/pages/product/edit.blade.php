                                            ...
                                            <div class="row mb-4">
                                                ...
                                                <div class="col-4">
                                                    <div class="form-outline">
                                                        ...
                                                        <input type="text" id="product_slug" name="product_slug"
                                                            class="form-control" value="{{ $product->product_slug }}"
                                                ...
                                                <div class="col-4">
                                                    <div class="form-outline">
                                                        ...
                                                        <input type="number" id="product_price" name="product_quantity"
                                                            class="form-control" value="{{ $product->product_quantity }}"
                                                ...
                                                <div class="col-4">
                                                    <div class="form-outline">
                                                        ...
                                                        <img src="{{ asset('uploads/product/' . $product->product_img) }}"
                                                            alt="" height="100" width="100">
                                                        <input type="hidden" name="old_product_img" class="form-control"
